      ...
      viewTreeObserver.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
        ...
        public void onGlobalLayout() {
          ...
          if (isAdded() && activity != null) {
            ...
            FrameLayout.LayoutParams camViewLayout = new FrameLayout.LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT, FrameLayout.LayoutParams.MATCH_PARENT);
  ...
  public void setFocusArea(final int pointX, final int pointY, final Camera.AutoFocusCallback callback) {
    if (mCamera != null) {
      ...
      if (parameters.getMaxNumMeteringAreas() > 0) {
        parameters.setMeteringAreas(Collections.singletonList(new Camera.Area(focusRect, 1000)));
      }
